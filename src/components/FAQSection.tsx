...
const faqItems = [
  {
    ...
    a: "Пришлите визуализации или фото интерьера — мы подберём коллекции Фрамир, которые подходят по стилю, цвету и пропорциям. Также можем предложить решения по покрытиям и фурнитуре.",
  },
  {
    q: "Чем отличаются покрытия?",
    a: "Фрамир предлагает эмаль, шпон натуральный, экошпон, покрытия под покраску и стекло. Каждое покрытие отличается по текстуре, износостойкости и цене. Поможем выбрать оптимальный вариант.",
  },
  {
  ...
  },
  {
    ...
    a: "Да. Коллекция скрытых дверей Фрамир включает скрытый короб 35 мм и 60 мм, а также скрытый пенал. Двери монтируются заподлицо со стеной и красятся в цвет стены.",
  },
  {
